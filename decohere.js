...
(async function main() {
  try {
    ...
    function frame(time) {
      ...
      { const dawn = smoothstep(Re - 0.55, Re, bf); sun.material.opacity = dawn * (0.46 + 0.05 * Math.sin(t * 0.6)); sun.position.y = 40 + dawn * 14; }   // top-right sunrise glow swells + gently rises at the very end
